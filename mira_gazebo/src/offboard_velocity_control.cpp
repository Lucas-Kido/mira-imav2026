...
public:
    OffboardVelocityControl() : Node("offboard_velocity_control") {
        ...
        takeoff_srv_ = this->create_service<mira_msgs::srv::Takeoff>("takeoff", std::bind(&OffboardVelocityControl::takeoff_callback, this, std::placeholders::_1, std::placeholders::_2));
        
        set_velocity_srv_ = this->create_service<mira_msgs::srv::SetVelocity>(
...
private:
    ...
    rclcpp::Service<mira_msgs::srv::Takeoff>::SharedPtr takeoff_srv_;
    rclcpp::Service<mira_msgs::srv::SetVelocity>::SharedPtr set_velocity_srv_;
    ...
    void takeoff_callback(const std::shared_ptr<mira_msgs::srv::Takeoff::Request> request, std::shared_ptr<mira_msgs::srv::Takeoff::Response> response) {
        if (estop_active_) {
            response->success = false;
    ...
    void set_velocity_callback(const std::shared_ptr<mira_msgs::srv::SetVelocity::Request> request, std::shared_ptr<mira_msgs::srv::SetVelocity::Response> response) {
        if (estop_active_) {
            response->success = false;
